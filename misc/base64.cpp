...
int main()
{
    ...
    std::string decoded_pattern =  websocketpp::base64_decode("XC4q==");
    bool are_equal = pattern == decoded_pattern;
    std::cout << pattern << " " << decoded_pattern << "\n";
    std::cout << "Are equal? : " << are_equal << "\n";
    return 0;
}